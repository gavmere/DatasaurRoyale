...
from Dinosaur import goToGreensOnly, goToNearestDino, fiftyFftydinoPlans, cowardDino, randomBehav, paralyzed, getStats, copDino, colorblindDino, maxConsumption, minConsumption, greenPrefered, omnivoreDino
...
class Fullsimulation:
    ...
    def __init__(self, autonomous=False, funmode = False):
        ...
        self.dino_pos = []
        self.death = []
        self.behaviors = [goToGreensOnly, goToNearestDino, fiftyFftydinoPlans, cowardDino, randomBehav, paralyzed, copDino, colorblindDino, maxConsumption, minConsumption, greenPrefered, omnivoreDino]
